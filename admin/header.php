...
<head>
	...
	include 'config.php';
	?>
	<title>ATK Sonya Fotocopy</title>
...
<body>
	<div class="navbar navbar-default">
		<div class="container-fluid">
			<div class="navbar-header">
				<a href="http://www.stationary.co.id/" class="navbar-brand">ATK Sonya Fotocopy</a>
	...
	<div class="col-md-2">
		...
		<ul class="nav nav-pills nav-stacked">
			...
			<li><a href="Penjualan.php"><span class="glyphicon glyphicon-user"></span>  Detail Penjualan</a></li>	
			...
			<li><a href="tambahlogin.php"><span class="glyphicon glyphicon-user"></span>  Tambah Login</a></li>	
			<li><a href="laporan.php"><span class="glyphicon glyphicon-print"></span>  Laporan Penjualan</a></li>	
