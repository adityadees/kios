...
$pdf->SetX(4);            
$pdf->MultiCell(19.5,0.5,'KIOS SOLEHUDDIN',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Telpon : 0822XXXXXXX',0,'L');    
$pdf->SetFont('Arial','B',10);
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'JL. Al Gazali',0,'L');
$pdf->SetX(4);
$pdf->MultiCell(19.5,0.5,'Email : msolehuddin2@gmail.com',0,'L');
